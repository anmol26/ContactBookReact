    ...
    render() {
        return (
            ...
            <div style={{ width:"100%", boxShadow: "0 0 10px 10px grey", display: "flex", flexFlow: "row wrap"}}>
                    ...
                    <input type="text" id="name" name="name" style={{ height: "30px", width: "100%" }} value={this.props.isEdit ? this.state.formData.name : null} onChange={(e) => this.setFormData({...this.state.formDate, name:e.target.value})} /><br /><br />
                    ...
                    <input type="text" id="address" name="address" style={{ height: "80px", width: "100%" }} value={this.props.isEdit ? this.state.formData.address : null} onChange={(e) => this.setFormData({ ...this.state.formDate, address: e.target.value })} /><br /><br/>
